...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap -->
    <link href="/src/bootstrap-3.3.6/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="/src/jasny-bootstrap/css/jasny-bootstrap.min.css">
    <link rel="stylesheet" href="/src/custom2.css">
  ...
  <body>
    ...
    <script src="/src/jquery-2.1.3.js"></script>
    <!-- Include all compiled plugins (below), or include individual files as needed -->
    <script src="/src/bootstrap-3.3.6/js/bootstrap.min.js"></script>
    <script src="/src/jquery-ui/jquery-ui.min.js"></script>
    <script src="/src/jasny-bootstrap/js/jasny-bootstrap.min.js"></script>
